...
function RenderCertificates()
{
    return(
        <div  className="certificatebody">
          ...
          <img src="./certificates/certificate1.png" alt="my picture" width="400px" height="300" />
          ...
          <img src="./certificates/deepLearning.png" alt="my picture" width="400px" height="300" />
          ...
          <img src="./certificates/dataStructures.jpeg" alt="my picture" width="400px" height="300" />
          ...
          <img src="./certificates/Algorithms.jpeg" alt="my picture" width="400px" height="300" />
          ...
          <img src="./certificates/eva.png" alt="my picture" width="400px" height="300" />
